    ...
    <Card raised sx={{ maxWidth: 500}}>
      ...
      <CardHeader
        title={
            ...
            <Grid item xs={7}>
              <Typography align="center" variant="body1" >Hall {props.info.numero_sala}</Typography>
            </Grid>
            <Grid item >
              <Typography align="center" variant="body1" >{props.info.capienza} Seats</Typography>
            </Grid>
          </Grid>  
        }
        action={
